 ...
 *  * Build: http://www.modernizr.com/download/#-canvas-canvastext-audio-shiv-cssclasses-load
 *   */
;
window.Modernizr = function(a,b,c) { 
	...
	var d = "2.5.3",
		...
		m.canvastext = function() {
			return!!e.canvas&&!!w(b.createElement("canvas").getContext("2d").fillText,"function")
		},
		m.audio=function() {
							...
							a.createDocumentFragment = Function(
									...
									"return 
										function () { 
											var n = f.cloneNode(),
												c = n.createElement;
											h.shivMethods&&("+h().join().replace(/\w+/g,
												function(a){
													return 	b[a] = c(a),
															f.createElement(a),
															'c("'+a+'")'
						...
						function g(a,e,f,g,i) { 
							...
							j.bypass || 
								(
									...
									j.instead ? j.instead(a,e,f,g,i) : 
									(y[j.url] ? j.noexec = !0 : y[j.url]=1,
										f.load(j.url, j.forceCSS || !j.forceJS&&"css" == j.url.split(".").pop().split("?").shift() ? "c" : c,
										j.noexec,
										j.attrs,
										j.timeout),
